...
// 1. photos
const photoPrincipale = "/photos/expo_nomade/Fantasia_1_top.jpg"
// On génère 17 photos (de Fantasia_2 à Fantasia_18)
const photos = ref(Array.from({ length: 17 }, (_, i) => `/photos/expo_nomade/Fantasia_${i + 2}.jpg`))
  ...
  <div class="expo-container">
    ...
    <header class="expo-header">
      ...
      <div class="expo-titre">
        <h2>Expo Nomade</h2>
        <span class="sous-titre">Photos de Fantasia</span>
